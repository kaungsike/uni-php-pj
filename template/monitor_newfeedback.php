...
<div id="edit_profile_modal" class="blur-me fixed hidden z-50 inset-0 flex justify-center items-center p-4 sm:p-8 overflow-y-auto">
    ...
    <div class="w-full sm:max-w-xl md:max-w-2xl  bg-white h-auto max-h-[90vh] flex flex-col items-center border border-neutral-300 rounded-lg xl:p-4 p-0 sm:p-6 overflow-y-auto">
