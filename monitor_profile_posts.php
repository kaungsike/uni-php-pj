            ...
            <div class="-mt-8 relative w-full space-y-8 items-center flex flex-col">
                ...
                <div class="p-5 mb-4 xl:mt-[32px] pt-[110px] xl:pt-[100px] mx-auto border-y-0 min-h-screen border xl:w-[900px]">
                    ...
                    <ol class="mt-3 divide-y divide-gray-200 dark:divide-gray-700">
                        <?php
                        $sql = "SELECT posts.*, users.name AS user_name, users.profile_photo AS user_profile_photo FROM posts INNER JOIN users ON posts.user_id = users.id WHERE posts.status = 'approved' AND posts.user_id = $monitor_id AND posts.is_anonymous = 0 ORDER BY posts.created_at DESC";
