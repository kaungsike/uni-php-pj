    ...
    <div class="sm:ml-64">
        ...
        <main class="w-full min-h-screen flex-1 overflow-y-auto scroll-smooth max-sm:mt-16 pt-0">
            ...
            <div class="w-full">
                ...
                $pending_post_sql = "SELECT posts.*, users.name AS student_name, users.profile_photo as student_profile_photo FROM posts INNER JOIN users ON posts.user_id = users.id WHERE posts.status = 'refused'";
