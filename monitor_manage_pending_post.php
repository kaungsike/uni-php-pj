...
<div class="w-full h-full">
    ...
    <div class="sm:ml-64">
        ...
        <main class="w-full min-h-screen flex-1 overflow-y-auto scroll-smooth max-sm:mt-16 pt-0">
            ...
            $pending_post_sql = "SELECT posts.*, students.name AS student_name, students.profile_photo as student_profile_photo FROM posts INNER JOIN students ON posts.student_id = students.id WHERE posts.status = 'pending'";
